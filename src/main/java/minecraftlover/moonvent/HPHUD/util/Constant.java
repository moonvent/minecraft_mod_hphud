...
public final class Constant {
        ...
        public static final class LocalizationKey {
                public static final String GREETINGS_IN_WORLD = "chat." + MOD_NAME_FOR_LOCALIZATION + ".welcome";
                public static final String SETTINGS_CATEGORY_NAME = "category." + MOD_NAME_FOR_LOCALIZATION
                                + ".general";
                public static final String SETTINGS_DESCRIPTION_CONFIGURE_KEY = "key." + MOD_NAME_FOR_LOCALIZATION + ".open_menu";
        }
